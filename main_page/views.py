    ...
    if is_logged:
        if request.method == 'POST':
            ...
            if len(mood_data_list) != 0:
                ...
                # _dir = os.path.join("D:/", "projects", "Django", "JakSieMasz", "main_page", "static", "images", "auto-generated-charts", "user-" + str(user_id_s))
                _dir = os.path.join("/", "opt", "lampp", "htdocs", "main_page", "static", "images", "auto-generated-charts", "user-" + str(user_id_s))
                if not os.path.exists(_dir):
                    os.mkdir(_dir)

                # strFile = 'D:/projects/Django/JakSieMasz/main_page/static/images/auto-generated-charts/user-' + str(user_id_s) + '/last_well_being.png'
                strFile = '/opt/lampp/htdocs/main_page/static/images/auto-generated-charts/user-'+ str(user_id_s) + '/last_well_being.png'
